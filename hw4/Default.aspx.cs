...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sortBy = rblSortType.SelectedValue;
    ...
    private string getSQL(String sortBy)
    {

        // Write code to return SQL statement to retrieve the required data.
        if (sortBy.Equals("price"))
        {
            return "Select ListPrice, SqFeet, Beds, Baths, YearBuilt FROM Properties ORDER BY ListPrice ASC";
        }
        else
            return "Select ListPrice, SqFeet, Beds, Baths, YearBuilt FROM Properties ORDER BY SqFeet ASC";
    }
